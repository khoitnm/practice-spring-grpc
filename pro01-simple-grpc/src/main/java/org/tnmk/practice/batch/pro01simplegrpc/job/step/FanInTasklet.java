package org.tnmk.practice.batch.pro01simplegrpc.job.step;
...
import org.tnmk.practice.batch.pro01simplegrpc.job.BatchJobConfig;
...
public class FanInTasklet<T> implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        ...
        log.info("Thread[{}]: Executing Pro01SimpleGrpc: JobInstance: {}, Step contribution: {}, chunkContext: {}", Thread.currentThread().getName(), jobInstance, contribution, chunkContext);
