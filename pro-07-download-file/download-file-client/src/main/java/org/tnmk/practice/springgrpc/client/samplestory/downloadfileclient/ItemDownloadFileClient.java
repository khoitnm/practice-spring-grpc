...
@Component
public class ItemDownloadFileClient {
    public static final Logger logger = LoggerFactory.getLogger(ItemDownloadFileClient.class);
    ...
    @Autowired
    public ItemDownloadFileClient(GrpcClientStubFactory grpcClientStubFactory, ItemMapper itemMapper) {
