package org.tnmk.practice.springgrpc.pro02serversimpleheaderanderror;
...
import org.tnmk.practice.springgrpc.pro02serversimpleheaderanderror.grpcservice.SampleItemGrpcService;
import org.tnmk.practice.springgrpc.pro02serversimpleheaderanderror.service.ItemIdConstants;
...
public class SampleItemGrpcServiceTest {
    ...
    public void test_GetItem_Empty_Success() {
        ItemIdProto itemIdProto = ItemIdProto.newBuilder().setId(ItemIdConstants.EMPTY_ITEM_ID).build();
        ItemProto itemProto = stub.getItem(itemIdProto);
        Assert.assertNotNull(itemProto.getId());
    }
