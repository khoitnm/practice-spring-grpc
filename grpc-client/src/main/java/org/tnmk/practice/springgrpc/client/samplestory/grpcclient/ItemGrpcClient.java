package org.tnmk.practice.springgrpc.client.samplestory.grpcclient;
...
public class ItemGrpcClient {
    ...
    @Autowired
    public ItemGrpcClient(ItemGrpcConnectionProperties connectionProperties, ItemMapper itemMapper) {
